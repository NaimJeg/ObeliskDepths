...
public final class LangZhCnProvider extends LanguageProvider {
    ...
    private void addPortalUi() {
        ...
        add("gui.obeliskdepths.portal.mode.starter_only", "仅开启者");
        add("gui.obeliskdepths.portal.mode.open", "开放");
        add(
        ...
        add(
                ...
                "传送门有效期间，任何抵达此处的玩家都可以进入。"
        );
        add("gui.obeliskdepths.portal.selected.starter_only", "已选择：仅开启者");
        add("gui.obeliskdepths.portal.selected.open", "已选择：开放传送门");
