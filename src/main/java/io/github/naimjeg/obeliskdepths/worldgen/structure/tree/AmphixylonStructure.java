...
public final class AmphixylonStructure extends Structure {
    public static final MapCodec<AmphixylonStructure> CODEC =
            Structure.simpleCodec(AmphixylonStructure::new);
    ...
    public AmphixylonStructure(StructureSettings settings) {
        super(settings);
    }
    ...
    protected Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (maxY - minY < 96
            ...
            ObeliskDepths.LOGGER.warn(
                    "[OD structure] rejected Amphixylon candidate chunk={} reason=height-too-small surfaceY={} minY={} maxY={} dimensionMinY={} dimensionMaxY={}",
                    chunkPos,
                    surfaceY,
                    minY,
                    maxY,
        ...
        int maxRadius = AmphixylonSite.MIN_RADIUS
                + intRange(
                treeSeed,
                3,
                AmphixylonSite.MAX_RADIUS - AmphixylonSite.MIN_RADIUS + 1
        );
        ...
        AmphixylonField field = new AmphixylonField(site);
        BiomeValidation biomeValidation = validateBiomes(context, site);

        if (!biomeValidation.valid()) {
            ObeliskDepths.LOGGER.warn(
                    "[OD structure] rejected Amphixylon biome candidate chunk={} center={},{} seed={} validation={} samples={}",
                    chunkPos,
                    centerX,
                    centerZ,
                    treeSeed,
        ...
        if (!field.validatePlan()) {
            ObeliskDepths.LOGGER.warn(
                    "[OD structure] rejected invalid Amphixylon plan chunk={} center={},{} seed={} bounds={}",
                    chunkPos,
                    centerX,
                    centerZ,
                    treeSeed,
        ...
        ObeliskDepths.LOGGER.debug(
                "[OD structure] accepted Amphixylon startChunk={} center={},{} treeSeed={} surfaceY={} minY={} maxY={} maxRadius={} biomeValidation={} pieceCount={} bounds={}",
                chunkPos,
                centerX,
                centerZ,
                treeSeed,
        ...
        return Optional.of(new GenerationStub(
                startPos,
                builder -> {
                    builder.addPiece(new AmphixylonPiece(
                            AmphixylonPiece.Role.TRUNK,
                            -1,
                            site,
                            field.trunkBounds()
                    ));
                    ...
                    for (int i = 0; i < field.lowerRootCount(); i++) {
                        builder.addPiece(new AmphixylonPiece(
                                AmphixylonPiece.Role.LOWER_ROOT,
                                i,
                                site,
                    ...
                    for (int i = 0; i < field.upperRootCount(); i++) {
                        builder.addPiece(new AmphixylonPiece(
                                AmphixylonPiece.Role.UPPER_ROOT,
                                i,
                                site,
                    ...
                    for (int i = 0; i < field.branchCount(); i++) {
                        builder.addPiece(new AmphixylonPiece(
                                AmphixylonPiece.Role.BRANCH_CANOPY,
                                i,
                                site,
    ...
    public StructureType<?> type() {
        return ModWorldgen.AMPHIXYLON.get();
    }
