...
public final class GreatSwampHourglassTreePiece extends StructurePiece {
    ...
    private void placeBranchVines(
        ...
        BlockState support = ModBlocks.GREAT_SWAMP_TAXODIUM_VINE_BULB.get().defaultBlockState();
    ...
    private static boolean placeVineSupport(
        ...
        boolean replaceWithBulb =
                current.isAir()
                        ...
                        || current.is(
                        ModBlocks.GREAT_SWAMP_TAXODIUM
                                .leaves()
                                .get()
                )
                        || current.is(
                        ModBlocks.GREAT_SWAMP_TAXODIUM_ROOT_TANGLE
                                .get()
                );
    ...
    private static boolean isTaxodiumTreeBlock(BlockState state) {
        return state.is(ModBlocks.GREAT_SWAMP_TAXODIUM.log().get())
                ...
                || state.is(ModBlocks.GREAT_SWAMP_TAXODIUM_VINE_BULB.get())
