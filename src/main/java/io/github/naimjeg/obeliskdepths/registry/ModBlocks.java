...
import io.github.naimjeg.obeliskdepths.block.*;
...
public final class ModBlocks {
    ...
    private static final float VINE_BULB_HARDNESS = 1.0F;
    private static final float VINE_BULB_RESISTANCE = 1.0F;
    private static final int VINE_BULB_LIGHT_LEVEL = 15;
    ...
    public static final DeferredBlock<ObeliskBlock> OBELISK = BLOCKS.register(
            "obelisk",
            registryName -> new ObeliskBlock(
                    baseProperties(
                            registryName,
                            3.0F,
                            6.0F,
    ...
    public static final DeferredBlock<ObeliskChestBlock> OBELISK_CHEST = BLOCKS.register(
            "obelisk_chest",
            registryName -> new ObeliskChestBlock(baseProperties(
                    registryName,
    ...
    public static final DeferredItem<BlockItem> OBELISK_CHEST_ITEM =
            registerBlockItem(OBELISK_CHEST);
...
//            registerBlockItem(GREAT_SWAMP_ROOTED_DIRT);
    ...
    public static final WoodBlockSet AMPHIXYLON =
            registerWoodSet(
                    "amphixylon",
    ...
    public static final DeferredBlock<Block> AMPHIXYLON_ROOT_TANGLE =
            registerBlock(
                    "amphixylon_root_tangle",
    ...
    public static final DeferredItem<BlockItem> AMPHIXYLON_ROOT_TANGLE_ITEM =
            registerBlockItem(AMPHIXYLON_ROOT_TANGLE);

    public static final DeferredBlock<Block> AMPHIXYLON_VINE_BULB =
            BLOCKS.register(
                    "amphixylon_vine_bulb",
                    registryName -> new Block(
                            baseProperties(
                                    registryName,
                                    VINE_BULB_HARDNESS,
                                    VINE_BULB_RESISTANCE,
                                    SoundType.SHROOMLIGHT
                            )
                                    .lightLevel(state -> VINE_BULB_LIGHT_LEVEL)
                                    .ignitedByLava()
                    )
            );

    public static final DeferredItem<BlockItem> AMPHIXYLON_VINE_BULB_ITEM =
            registerBlockItem(AMPHIXYLON_VINE_BULB);
    ...
    public static final List<DeferredItem<? extends Item>> BUILDING_BLOCK_ITEMS =
            Stream.concat(
                    ...
                    List.<DeferredItem<? extends Item>>of(
                            ...
                            AMPHIXYLON_ROOT_TANGLE_ITEM,
                            AMPHIXYLON_VINE_BULB_ITEM,
                            DUNGEON_LAMP_ITEM,
...
//                    hangingSignItem,
    ...
    private static WoodBlockSet registerWoodSet(
            ...
            Supplier<BlockSetType> blockSetType
    ) {
