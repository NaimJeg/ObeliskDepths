...
public enum DungeonPortalEntryResult {
    ...
    DESTINATION_NOT_PREPARED("message.obeliskdepths.portal.entry.destination_not_prepared"),
    DESTINATION_STABILIZING("message.obeliskdepths.portal.entry.destination_stabilizing"),
