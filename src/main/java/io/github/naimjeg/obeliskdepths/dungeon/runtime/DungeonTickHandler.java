...
public final class DungeonTickHandler {
    ...
    private static void tickPreparationRuntime(ServerLevel level) {
        ...
        // Entry operations are advanced after preparation/recovery so a newly
        // published prepared entry can teleport in the same owner-thread tick.
        DungeonPortalEntryService.tick(level);
    }
