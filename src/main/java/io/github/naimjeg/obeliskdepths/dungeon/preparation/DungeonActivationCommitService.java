...
public final class DungeonActivationCommitService {
    ...
    static DungeonActivationCommitResult commitPrepared(
    ...
    static void finishSuccessfulPreparedActivation(
            ServerLevel dungeonLevel,
            DungeonPreparationJob job,
        ...
        ObeliskDepths.LOGGER.info(
                "Opened prepared dungeon portal instance={} session={} anchor={} accessPolicy={}",
                ...
                job.request().accessPolicy().getSerializedName()
        );
    }
}
