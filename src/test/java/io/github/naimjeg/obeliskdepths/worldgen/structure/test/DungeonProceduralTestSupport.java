...
public final class DungeonProceduralTestSupport {
    public static final int PRODUCTION_SPATIAL_LAYOUT_ATTEMPTS =
            ObeliskDungeonStructure.MAX_SPATIAL_LAYOUT_ATTEMPTS;
    ...
    public static DungeonGenerationPlan generationPlan(
        ...
        ResolvedDungeonLayout resolved = DungeonGenerationPlanner.resolveLayout(
                graph,
                analysis,
                origin,
                CATALOG,
        ...
        return DungeonGenerationPlanner.fromResolved(resolved);
    }
