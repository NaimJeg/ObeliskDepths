...
public final class DungeonExactGeometryTest {
    ...
    private static void deterministicPieceMetadata() {
        ...
        DungeonLayoutPlan secondLayout =
                DungeonGraphEmbeddingPlanner.embed(graph, layoutOrigin, CATALOG);
        DungeonWorldgenTrace.Context trace = DungeonWorldgenTrace.Context.disabled(null);
        ResolvedDungeonLayout firstResolved = DungeonLayoutResolver.resolveProcedural(
                layoutOrigin,
                firstLayout,
        ...
        ResolvedDungeonLayout secondResolved = DungeonLayoutResolver.resolveProcedural(
                layoutOrigin,
                secondLayout,
                graph.primaryEntryNodeId(),
                CATALOG,
